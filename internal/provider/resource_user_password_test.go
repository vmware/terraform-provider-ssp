...
resource "ssp_user_password" "test" {
  username     = "admin"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ssp_user_password.test", "id", "pwd-reset-admin"),
					resource.TestCheckResourceAttr("ssp_user_password.test", "username", "admin"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ssp_user_password.test", "id", "pwd-change"),
				),
			},
		},
	})
