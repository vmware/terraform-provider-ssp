...
resource "ssp_installer_backup_config" "test" {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ssp_installer_backup_config.test", "id", "singleton"),
					resource.TestCheckResourceAttr("ssp_installer_backup_config.test", "server_address", "sftp.corp.local"),
					resource.TestCheckResourceAttr("ssp_installer_backup_config.test", "username", "backupuser"),
					resource.TestCheckResourceAttr("ssp_installer_backup_config.test", "backup_location", "/backups"),
				),
			},
		},
	})
