		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ssp_platform.test", "id", "platform-1"),
					resource.TestCheckResourceAttr("ssp_platform.test", "provider_id", "vsphere-provider-1"),
					resource.TestCheckResourceAttr("ssp_platform.test", "form_factor", "COMPACT"),
					resource.TestCheckResourceAttr("ssp_platform.test", "worker_count", "3"),
					resource.TestCheckResourceAttr("ssp_platform.test", "status", "DEPLOYMENT"),
				),
			},
		},
	})
