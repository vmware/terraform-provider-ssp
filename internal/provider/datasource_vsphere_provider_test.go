		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.ssp_vsphere_provider.test", "id", "vsphere-provider-1"),
					resource.TestCheckResourceAttr("data.ssp_vsphere_provider.test", "server", "vcenter.corp.local"),
					resource.TestCheckResourceAttr("data.ssp_vsphere_provider.test", "user", "administrator@vsphere.local"),
				),
			},
		},
	})
