...
resource "ssp_ldap_identity_source" "test" {
  domain     = "corp.local"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet("ssp_ldap_identity_source.test", "id"),
					resource.TestCheckResourceAttr("ssp_ldap_identity_source.test", "domain", "corp.local"),
					resource.TestCheckResourceAttr("ssp_ldap_identity_source.test", "server", "ldap.corp.local"),
					resource.TestCheckResourceAttr("ssp_ldap_identity_source.test", "port", "636"),
					resource.TestCheckResourceAttr("ssp_ldap_identity_source.test", "base_dn", "dc=corp,dc=local"),
				),
			},
		},
	})
