		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.ssp_platform.test", "id", "platform-1"),
					resource.TestCheckResourceAttrSet("data.ssp_platform.test", "domain"),
					resource.TestCheckResourceAttrSet("data.ssp_platform.test", "status"),
				),
			},
		},
	})
