		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.ssp_bundle.test", "id", "bundle-1"),
					resource.TestCheckResourceAttr("data.ssp_bundle.test", "status", "READY"),
					resource.TestCheckResourceAttr("data.ssp_bundle.test", "version", "1.2.3"),
				),
			},
		},
	})
